...
public class Main extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		MenuItem item1 = menu.add(0, MENU_OPT1, 0, R.string.menu_opt1);
		item1.setIcon(R.drawable.ic_menu_play_clip);
		MenuItem item2 = menu.add(0, MENU_OPT2, 1, R.string.menu_opt2);
